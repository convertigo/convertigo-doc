...
metadesc: Gets the authenticated user ID from the context/session.    The  Get authenticated user  step allows to retrieve in an XML Element the authenticated u
ObjGroup: Sequencer
