...
metadesc: Defines a step extracting a string from a source into a variable in Javascript scope.    The  jSimpleSource  step gets a single node from the source d
ObjGroup: Sequencer
