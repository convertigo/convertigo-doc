...
metadesc: Defines a request criterion based on HTTP headers for Site Clipper screen classes.    The  Request header  criterion allows defining a regular express
