...
metadesc: Defines an HTTP response associated with the operation.    When a services is invoked it responds with a HTTP status code. This mapping object will he
ObjGroup: URL Mapper
