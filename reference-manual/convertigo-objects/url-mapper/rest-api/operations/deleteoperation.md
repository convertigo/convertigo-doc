...
metadesc: Defines an HTTP DELETE operation associated with the mapping.    For a given operation on a given mapping you define here what should be the Sequence 
ObjGroup: URL Mapper
