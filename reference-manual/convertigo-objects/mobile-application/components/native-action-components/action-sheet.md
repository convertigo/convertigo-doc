...
<u>Supported platorm(s):</u> <ul><li>Android</li><li>iOS</li></ul>You can access data from the next action in the chain in (TS) mode with: <code><ul><li>out: The index of the selected button</li></ul></code>Whenever cordova platform is not available, the value defined in mocking options is returned.
