...
metadesc: Defines a  Else Handler .    A  Else Handler  must be added to an  IfElse  action.  It helps defining actions to be executed when the  IfElse  conditi
ObjGroup: Controls
...
##### Defines a <i>Else Handler</i>. <br/>
 ...
 <p>A <i>Else Handler</i> must be added to an <i>IfElse</i> action.</p><p>It helps defining actions to be executed when the <i>IfElse</i> condition is not verified.</p>
