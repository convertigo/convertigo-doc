...
metadesc: References an XSD file and includes its schemas in this project.    The  Include XSD schema  reference enhances the current project's schema by includ
ObjGroup: Common
