...
title: GetView
sidebar: c8o_sidebar
permalink: reference-manual/convertigo-objects/databases/couchdb/other-transactions/getview/
metadesc: Executes the specified view function from the specified design document.    GET /{db}/_design/{ddoc}/_view/{view}   Response Headers     ETag – Respon
ObjGroup: Databases
ObjCatName: other-transactions
ObjName: GetView
ObjClass: com.twinsoft.convertigo.beans.transactions.couchdb.GetViewTransaction
ObjIcon: /images/beans/transactions/couchdb/images/getview_color_32x32.png
topnav: topnavobj
---
...
Param ddoc | String | standard | Design document name
Param view | String | standard | View function name
Query att_encoding_info | String | standard | (boolean) – Include encoding information in attachment stubs if include_docs is true and the particular attachment is compressed. Ignored if include_docs isn’t true. Default is false
Query attachments | String | standard | (boolean) – Include the Base64-encoded content of attachments in the documents that are included if include_docs is true. Ignored if include_docs isn’t true. Default is false
