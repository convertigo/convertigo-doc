...
title: AllDocs
sidebar: c8o_sidebar
permalink: reference-manual/convertigo-objects/databases/couchdb/other-transactions/alldocs/
metadesc: Returns a JSON structure of all of the documents in a given database. The information is returned as a JSON structure containing meta information abou
ObjGroup: Databases
ObjCatName: other-transactions
ObjName: AllDocs
ObjClass: com.twinsoft.convertigo.beans.transactions.couchdb.AllDocsTransaction
ObjIcon: /images/beans/transactions/couchdb/images/alldocs_color_32x32.png
topnav: topnavobj
---
