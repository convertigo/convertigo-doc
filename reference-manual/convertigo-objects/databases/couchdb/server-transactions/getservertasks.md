...
metadesc: List of running tasks, including the task type, name, status and process ID.    GET /_active_tasks   Response JSON Object      changes_done  (number) 
ObjGroup: Databases
