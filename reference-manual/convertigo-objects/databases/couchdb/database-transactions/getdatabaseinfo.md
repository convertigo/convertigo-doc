...
sidebar: c8o_sidebar
permalink: reference-manual/convertigo-objects/databases/couchdb/database-transactions/getdatabaseinfo/
metadesc: Gets information about the specified database.    GET /{db}   Response JSON Object      committed_update_seq  (number) – The number of committed updat
ObjGroup: Databases
ObjCatName: database-transactions
ObjName: GetDatabaseInfo
ObjClass: com.twinsoft.convertigo.beans.transactions.couchdb.GetDatabaseInfoTransaction
ObjIcon: /images/beans/transactions/couchdb/images/getdatabaseinfo_color_32x32.png
topnav: topnavobj
---
