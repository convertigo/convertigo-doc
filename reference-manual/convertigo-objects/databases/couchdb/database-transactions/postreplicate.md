...
title: PostReplicate
sidebar: c8o_sidebar
permalink: reference-manual/convertigo-objects/databases/couchdb/database-transactions/postreplicate/
metadesc: Request, configure, or stop, a replication operation.    POST /_replicate   Response JSON Object      history  (array) – Replication history (see belo
ObjGroup: Databases
ObjCatName: database-transactions
ObjName: PostReplicate
ObjClass: com.twinsoft.convertigo.beans.transactions.couchdb.PostReplicateTransaction
ObjIcon: /images/beans/transactions/couchdb/images/postreplicate_color_32x32.png
topnav: topnavobj
---
...
Param cancel | String | standard | (boolean) – Cancels the replication
Param continuous | String | standard | (boolean) – Configure the replication to be continuous
