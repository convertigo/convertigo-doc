...
title: PutDatabase
sidebar: c8o_sidebar
permalink: reference-manual/convertigo-objects/databases/couchdb/database-transactions/putdatabase/
metadesc: Creates a new database.    The database name {db} must be composed by following next rules    Name must begin with a lowercase letter ( a-z )  Lowerca
ObjGroup: Databases
ObjCatName: database-transactions
ObjName: PutDatabase
ObjClass: com.twinsoft.convertigo.beans.transactions.couchdb.PutDatabaseTransaction
ObjIcon: /images/beans/transactions/couchdb/images/putdatabase_color_32x32.png
topnav: topnavobj
---
...
Query n | String | standard | (integer) – Replicas. The number of copies of the database in the cluster. The default is 3, unless overridden in the cluster config
Query q | String | standard | (integer) – Shards, aka the number of range partitions. Default is 8, unless overridden in the cluster config
