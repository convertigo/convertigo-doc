...
sidebar: c8o_sidebar
permalink: reference-manual/convertigo-objects/databases/couchdb/document-transactions/deletedocument/
metadesc: Marks the specified document as deleted by adding a field _deleted with the value true.    DELETE /{db}/{docid}   Response Headers     ETag – Double q
ObjGroup: Databases
ObjCatName: document-transactions
ObjName: DeleteDocument
ObjClass: com.twinsoft.convertigo.beans.transactions.couchdb.DeleteDocumentTransaction
ObjIcon: /images/beans/transactions/couchdb/images/deletedocument_color_32x32.png
topnav: topnavobj
---
...
Query rev | String | standard | (string) – Actual document’s revision
