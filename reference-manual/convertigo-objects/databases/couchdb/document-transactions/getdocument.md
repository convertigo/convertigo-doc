...
title: GetDocument
sidebar: c8o_sidebar
permalink: reference-manual/convertigo-objects/databases/couchdb/document-transactions/getdocument/
metadesc: Returns document by the specified docid from the specified db.    GET /{db}/{docid}   Response Headers     ETag – Double quoted document’s revision to
ObjGroup: Databases
ObjCatName: document-transactions
ObjName: GetDocument
ObjClass: com.twinsoft.convertigo.beans.transactions.couchdb.GetDocumentTransaction
ObjIcon: /images/beans/transactions/couchdb/images/getdocument_color_32x32.png
topnav: topnavobj
---
