...
title: PutUpdate
sidebar: c8o_sidebar
permalink: reference-manual/convertigo-objects/databases/couchdb/document-transactions/putupdate/
metadesc: Executes update function on server side for the specified document.    PUT /{db}/_design/{ddoc}/_update/{func}/{docid}   Response Headers      X-Couch
ObjGroup: Databases
ObjCatName: document-transactions
ObjName: PutUpdate
ObjClass: com.twinsoft.convertigo.beans.transactions.couchdb.PutUpdateTransaction
ObjIcon: /images/beans/transactions/couchdb/images/putupdate_color_32x32.png
topnav: topnavobj
---
...
Param func | String | standard | Update function name
...
UpdateName | String | standard | Use an existing update of an existing design document of the connector. Use 'ddoc' and 'func' variables if empty.
