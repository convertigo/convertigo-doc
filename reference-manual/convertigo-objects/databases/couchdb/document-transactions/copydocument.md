...
title: CopyDocument
sidebar: c8o_sidebar
permalink: reference-manual/convertigo-objects/databases/couchdb/document-transactions/copydocument/
metadesc: Defines an CouchDB database transaction which copy a document in a database.    COPY /{db}/{docid}   Response Headers     ETag – Double quoted documen
ObjGroup: Databases
ObjCatName: document-transactions
ObjName: CopyDocument
ObjClass: com.twinsoft.convertigo.beans.transactions.couchdb.CopyDocumentTransaction
ObjIcon: /images/beans/transactions/couchdb/images/copydocument_color_32x32.png
topnav: topnavobj
---
##### Defines an CouchDB database transaction which copy a document in a database.
...
Param destination | String | standard | (string) – Destination document
Param docid | String | standard | Document ID
Param rev destination rev | String | standard | (string) – Destination document revision. Optional
Query batch | String | standard | (string) – Stores document in batch mode Possible values: ok. Optional
Query rev | String | standard | (string) – Revision to copy from. Optional
