---
layout: page
title: DeleteDocumentAttachment
sidebar: c8o_sidebar
permalink: reference-manual/convertigo-objects/databases/couchdb/attachment-transactions/deletedocumentattachment/
metadesc: Deletes the attachment attachment of the specified doc.    DELETE /{db}/{docid}/{attname}   Response Headers     ETag – Double quoted document’s new r
ObjGroup: Databases
ObjCatName: attachment-transactions
ObjName: DeleteDocumentAttachment
ObjClass: com.twinsoft.convertigo.beans.transactions.couchdb.DeleteDocumentAttachmentTransaction
ObjIcon: /images/beans/transactions/couchdb/images/deletedocumentattachment_color_32x32.png
topnav: topnavobj
---
...
- **rev** rev (string) – Revision MVCC token
...
Query batch | String | standard | (string) – Store changes in batch mode Possible values: ok. Optional
