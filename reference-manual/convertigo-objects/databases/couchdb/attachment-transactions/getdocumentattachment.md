---
layout: page
title: GetDocumentAttachment
sidebar: c8o_sidebar
permalink: reference-manual/convertigo-objects/databases/couchdb/attachment-transactions/getdocumentattachment/
metadesc: Returns the file attachment associated with the document.    GET /{db}/{docid}/{attname}   Response Headers     Accept-Ranges – Range request aware. U
ObjGroup: Databases
ObjCatName: attachment-transactions
ObjName: GetDocumentAttachment
ObjClass: com.twinsoft.convertigo.beans.transactions.couchdb.GetDocumentAttachmentTransaction
ObjIcon: /images/beans/transactions/couchdb/images/getdocumentattachment_color_32x32.png
topnav: topnavobj
---
...
Param attpath | String | standard | Attachment path<br/>This path is either absolute or relative to Convertigo environment. Blank value will retrieved the attachment as a base64 string of a "data" field. Relative paths starting with:<br/><br/>- `./` are relative to Convertigo workspace,<br/>- `.//` are relative to current project folder.
Param db | String | standard | Database name
Param docid | String | standard | Document ID
Query rev | String | standard | (string) – Document’s revision. Optional
