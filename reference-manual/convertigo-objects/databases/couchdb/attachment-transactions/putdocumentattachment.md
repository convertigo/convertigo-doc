---
layout: page
title: PutDocumentAttachment
sidebar: c8o_sidebar
permalink: reference-manual/convertigo-objects/databases/couchdb/attachment-transactions/putdocumentattachment/
metadesc: Uploads the supplied content as an attachment to the specified document.    PUT /{db}/{docid}/{attname}   Response Headers     Accept-Ranges – Range r
ObjGroup: Databases
ObjCatName: attachment-transactions
ObjName: PutDocumentAttachment
ObjClass: com.twinsoft.convertigo.beans.transactions.couchdb.PutDocumentAttachmentTransaction
ObjIcon: /images/beans/transactions/couchdb/images/putdocumentattachment_color_32x32.png
topnav: topnavobj
---
...
- Content-Encoding – Used compression codec. Available if attachment’s content_type is in **list of compressiable types**
...
Param attbase64 | String | standard | Attachment base64 encoded<br/>The value is converted from a base64 string to a binary content. Used if attpath parameter is blank or if the file doesn't exist.
Param attcontent_type | String | standard | Attachment ContentType<br/>Define the ContentType of the attachment. This is the ContentType returned when the attachment is requested.
Param attname | String | standard | Attachment name
Param attpath | String | standard | Attachment path<br/>This path is either absolute or relative to Convertigo environment. Relative paths starting with:<br/><br/>- `./` are relative to Convertigo workspace,<br/>- `.//` are relative to current project folder.
Param db | String | standard | Database name
Param docid | String | standard | Document ID
Query rev | String | standard | (string) – Document revision. Required
