...
metadesc: Defines and handles keywords and commands found in legacy screens.    The  Commands  extraction rule detects keywords in the screen and transforms the
ObjGroup: Legacy
