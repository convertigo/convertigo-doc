...
--- | --- | --- | ---
Columns name | XMLVector | configuration | Defines the name of columns<br/>This property is a list of column names. <br/><span class="orangetwinsoft">Note:</span> A new column can be added to the list using the blue keyboard icon. The columns defined in the list can be ordered using the arrow up and arrow down buttons, or deleted using the red cross icon.
