...
metadesc: Defines a legacy screen criterion searching for an empty screen.    The  Empty screen  criterion applies to legacy applications, which are usually lau
ObjGroup: Legacy
ObjCatName: 
