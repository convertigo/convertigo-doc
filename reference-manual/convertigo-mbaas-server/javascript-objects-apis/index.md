...
String | **getProjectUrl**()<br><br>**Returns**: the absolute URL to the root project (The main project calling sub projects).<br><br>**See also**: getAbsoluteRequestedUrl(), getConvertigoUrl() | Gets the absolute URL of the current project root.
